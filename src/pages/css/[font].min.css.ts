...
export function GET({ params }) {
  ...
  let cssContent = font.FontWeights
    .map(weight => {
      ...
      return `@font-face{font-family:'${font.FontName}';src:url('/fonts/${font.FontPath}/${font.FontPath}-${weightName}.woff2') format('woff2');font-weight:${weight};font-style:normal;font-display:swap;}`;
    })
    .join('');
